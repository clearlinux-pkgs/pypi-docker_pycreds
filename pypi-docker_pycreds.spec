...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672269289
...
cp %{_builddir}/docker-pycreds-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-docker_pycreds/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
